    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(help_text='выберите курс', on_delete=django.db.models.deletion.CASCADE, related_name='lesson_set', to='edu_materials.course', verbose_name='курс')),
            ],
            options={
                'verbose_name': 'Урок',
